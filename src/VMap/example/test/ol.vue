 ...
 * @LastEditTime: 2024-12-25 15:26:16
-->
<template>
...
// import OlPolyline from '@/VMap/ol/v3/components/layer/vector/Polyline.vue'
import {
  createPointsFromBox,
...
export default {
  ...
  methods: {
    ...
    handleRadomPoint() {
      ...
      const pointsWithValue = createPointsFromBoxWithProperty(500, extent)
      console.log(pointsWithValue)
