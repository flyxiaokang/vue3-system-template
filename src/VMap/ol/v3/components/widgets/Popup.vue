 ...
 * @LastEditTime: 2025-05-18 10:01:08
 * @FilePath: \dywebd:\kjr\code\WaterNet\WaterNet-vue3\src\components\iFrame\Page1\Popup.vue
-->
<template>
  <div class="title">{{ title }} <span @click="handleClose">✕</span></div>
  <div class="content">
